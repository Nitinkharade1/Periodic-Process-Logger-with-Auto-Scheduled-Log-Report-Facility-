...
def MailSender(filename,time):
    try:
        fromaddr = "_____________"    # Add Sender Mail
        toaddr =   "_____________"    # Add Receiver Mail
        ...
        body = """
        Hello %s,
        Welcome to ProcessMonitorMemoryLogPeriodicMail.
        ...
        s.login(fromaddr,"____________")  # Add Password From google third party app
...
def ProcessLog(log_dir = 'Process'):     # Default name of Logfile
    listprocess = []
...
def main():
    print("---- ProcessMonitorMemoryLogPeriodicMail-----")
